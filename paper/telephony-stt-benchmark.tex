...
\hypersetup{
  ...
  pdfauthor={MM Intelligence Voice Research}
}
...
\author{%
  MM Intelligence, Voice Research\\[0.2em]
  \normalsize Applied Speech \& Conversational AI Group\\
  \normalsize \texttt{voice-research@example.org}%
}
\date{June 2026}
